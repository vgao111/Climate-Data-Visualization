...
(async function () {
  ...
  let world, climateData;
  try {
    [world, climateData] = await Promise.all([
      d3.json(TOPO_URL),
    ...
    document.getElementById('map-view').innerHTML =
      ...
      'Run the Colab export script first, then place the file in the data/ folder.</p>';
    return;
  }
  ...
  function buildMap() {
    ...
    mapSvg.selectAll('.country')
      ...
      .join('path')
      .attr('class', d => 'country' + (climateData[String(d.id)] ? ' has-data' : ''))
      .attr('d', path)
      .attr('fill', d => {
        const cd = climateData[String(d.id)];
